const e=""+new URL("../assets/shelter-to-service.webp",import.meta.url).href,a=""+new URL("../assets/breed-data-limitations.webp",import.meta.url).href,t=""+new URL("../assets/geographic-patterns.webp",import.meta.url).href,i=""+new URL("../assets/development-process.webp",import.meta.url).href,r=[{id:"shelter-to-service",title:"From Shelter to Service: The Case for Canine Rescue Candidate Identification",subtitle:"How data-driven screening transforms overlooked shelter dogs into life-saving professionals",category:"Research",date:"March 15, 2024",readTime:"8 min read",excerpt:"Thousands of dogs with the genetic profile and behavioral drives required for search-and-rescue work pass through American shelters every year — and most are never identified. This article explores the gap between shelter intake data and rescue program placement, and how structured screening can bridge it.",tags:["Data Science","Animal Welfare","Search & Rescue"],image:e,imageAlt:"A wet Golden Retriever wearing a working harness beside a rocky lake",photoCredit:{photographer:"Barnabas Davoti",sourceUrl:"https://www.pexels.com/photo/close-up-shot-of-a-golden-retriever-14840414/"},content:`
...
The data exists. The dogs exist. The programs exist. Rescue Retriever is the connection layer.
    `},{id:"breed-data-limitations",title:"Breed Classification in Shelter Data: Sources of Error and Practical Mitigation",subtitle:"Understanding the gap between visual breed assessment and genetic reality in animal shelter intake records",category:"Technical",date:"April 2, 2024",readTime:"6 min read",excerpt:"Shelter breed classifications are estimates made under time pressure by non-geneticists. For rescue candidate screening, understanding this limitation — and designing around it — is essential to building a reliable tool.",tags:["Data Quality","Methodology","Animal Science"],image:a,imageAlt:"Labrador, Collie, and other dog breeds sitting together outdoors",photoCredit:{photographer:"Blue Bird",sourceUrl:"https://www.pexels.com/photo/different-breeds-of-dogs-sitting-on-grass-8924984/"},content:`
...
Geographic analysis turns a static dataset into a strategic resource. Rescue Retriever's geolocation chart is the entry point for this analysis.
    `},{id:"development-process",title:"Building Rescue Retriever: Technical Decisions and Tradeoffs",subtitle:"An honest account of the architectural decisions, implementation challenges, and lessons learned building a shelter data application",category:"Technical",date:"May 5, 2024",readTime:"7 min read",excerpt:"A behind-the-scenes look at how Rescue Retriever was designed, built, and refined — including the decisions that worked and the ones that needed revision.",tags:["Development","Architecture","Lessons Learned"],image:i,imageAlt:"A laptop displaying programming code and a data analysis interface",photoCredit:{photographer:"Daniil Komov",sourceUrl:"https://www.pexels.com/photo/laptop-displaying-coding-and-data-analysis-interface-34804005/"},content:`
